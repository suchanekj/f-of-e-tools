...
VL_INLINE_OPT QData Vtop_sim::_change_request(Vtop_sim__Syms* __restrict vlSymsp) {
    ...
    VL_DEBUG_IF( if(__req && ((vlTOPp->top_sim__DOT__divider_reg_1 ^ vlTOPp->__Vchglast__TOP__top_sim__DOT__divider_reg_1))) VL_DBG_MSGF("        CHANGE: toplevel_sim.v:66: top_sim.divider_reg_1\n"); );
    VL_DEBUG_IF( if(__req && ((vlTOPp->top_sim__DOT__divider_reg_2 ^ vlTOPp->__Vchglast__TOP__top_sim__DOT__divider_reg_2))) VL_DBG_MSGF("        CHANGE: toplevel_sim.v:67: top_sim.divider_reg_2\n"); );
    VL_DEBUG_IF( if(__req && ((vlTOPp->top_sim__DOT__clk_delayed ^ vlTOPp->__Vchglast__TOP__top_sim__DOT__clk_delayed))) VL_DBG_MSGF("        CHANGE: toplevel_sim.v:70: top_sim.clk_delayed\n"); );
    // Final
