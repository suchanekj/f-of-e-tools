...
VL_INLINE_OPT void Vtop_sim::_combo__TOP__4(Vtop_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_sim::_combo__TOP__4\n"); );
    Vtop_sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void Vtop_sim::_combo__TOP__12(Vtop_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_sim::_combo__TOP__12\n"); );
    Vtop_sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->top_sim__DOT__clk_proc = ((IData)(vlTOPp->top_sim__DOT__data_clk_stall) 
                                      | (IData)(vlTOPp->top_sim__DOT__divider_reg_2));
...
VL_INLINE_OPT void Vtop_sim::_multiclk__TOP__13(Vtop_sim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_sim::_multiclk__TOP__13\n"); );
    Vtop_sim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->top_sim__DOT__processor__DOT__dataMemOut_fwd_mux_out 
        = ((2U & vlTOPp->top_sim__DOT__processor__DOT__ex_mem_out[0U])
