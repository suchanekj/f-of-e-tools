...
VL_MODULE(Vtop_sim) {
  ...
  public:
    static void _combo__TOP__12(Vtop_sim__Syms* __restrict vlSymsp);
    static void _combo__TOP__4(Vtop_sim__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _multiclk__TOP__13(Vtop_sim__Syms* __restrict vlSymsp);
