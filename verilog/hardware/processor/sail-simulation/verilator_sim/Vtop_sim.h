...
VL_MODULE(Vtop_sim) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top_sim__DOT__clk_actual;
        CData/*0:0*/ top_sim__DOT__data_clk_stall;
        CData/*0:0*/ top_sim__DOT__clkdivider__DOT__divider_regs_0;
        CData/*0:0*/ top_sim__DOT__clkdivider__DOT__divider_regs_1;
        CData/*2:0*/ top_sim__DOT__clkdivider__DOT__clk_mf;
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ top_sim__DOT__clkdivider__DOT____Vsenitemexpr1;
    CData/*0:0*/ top_sim__DOT__clkdivider__DOT____Vsenitemexpr2;
    CData/*2:0*/ __Vtableidx2;
    CData/*0:0*/ __VinpClk__TOP__top_sim__DOT__clk_proc;
    CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP__top_sim__DOT__clk_proc;
    CData/*0:0*/ __Vclklast__TOP__top_sim__DOT__clkdivider__DOT____Vsenitemexpr1;
    CData/*0:0*/ __Vclklast__TOP__top_sim__DOT__clkdivider__DOT____Vsenitemexpr2;
    CData/*0:0*/ __Vclklast__TOP__top_sim__DOT__clk_actual;
    CData/*0:0*/ __Vchglast__TOP__top_sim__DOT__clk_proc;
    CData/*0:0*/ __Vchglast__TOP__top_sim__DOT__clkdivider__DOT__divider_regs_0;
    CData/*0:0*/ __Vchglast__TOP__top_sim__DOT__clkdivider__DOT__divider_regs_1;
  ...
  public:
    static void _combo__TOP__10(Vtop_sim__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _multiclk__TOP__11(Vtop_sim__Syms* __restrict vlSymsp);
