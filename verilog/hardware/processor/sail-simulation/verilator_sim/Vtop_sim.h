...
VL_MODULE(Vtop_sim) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ top_sim__DOT__data_mem_inst__DOT__write_select0;
    ...
    struct {
        ...
        IData/*31:0*/ top_sim__DOT__data_mem_inst__DOT__addr_buf;
  ...
  public:
    static void _combo__TOP__9(Vtop_sim__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _multiclk__TOP__10(Vtop_sim__Syms* __restrict vlSymsp);
